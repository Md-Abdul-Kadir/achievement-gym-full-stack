        ...
        <>
            ...
            <div class="container">
                ...
                <div class="navbar-nav ms-auto px-5">
                   ...
                   <Nav.Link as={Link} to="/ourtrainer">Our Trainer</Nav.Link>
                    <Nav.Link as={Link} to="/aboutus">About Us</Nav.Link>
                            { user.displayName? <button onClick={logOut} className="btn btn-secondary rounded"variant="light"> LogOut</  button> : <Nav.Link as={Link} to="/login">LOG-IN</Nav.Link>
                            }
